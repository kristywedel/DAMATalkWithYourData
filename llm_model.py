...
class LLMModel:
    def __init__(self, model_name: str = "gpt2"):
        """
        Initializes the GPT-2 model for text generation.
        """
    ...
    def generate_response(self, 
        ...
        """
        Generates a chatbot response based on the query, relevant products, and relationships.

        Parameters:
        - query: User input query.
        - products: List of relevant products retrieved from the database.
        - relationships: List of related product relationships.
        ...
        # Construct the LLM input prompt
        prompt = f"""
